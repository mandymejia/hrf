...
#'
#' @return Invisibly returns the plot object generated by
#'   \code{\link[ciftiTools]{plot}}.
#'
#' @seealso \code{\link{plot_variance}}, \code{\link{regularize_allHRFs}},
#'   \code{\link[ciftiTools]{newdata_xifti}}
#'
#' @keywords internal
