...
fit_results_root_dir <- "/Volumes/LaCie/root/hrf_adaptation/validation_bonferroni_0.05_smoothed_RSS"
...
# HPC paths
output_dir <- "/N/project/hrf_adaptation/validation_bonferroni_0.05_smoothed_RSS/POCv2"
...
for(r in runs_to_process){
  ...
  for(data_type in data_types){
    ...
    output_file <- safe_path(output_dir, paste0("results_POCv2_", data_type, "_gambling_", run_names[r], "_weighted.rds"))
